...
const ManageDesignations = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'Designation created/updated successfully!' });
      setShowForm(false);
    ...
    <div>
      ...
      {showForm && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-6">
          <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Create/Update Designation</h3>

...
const ManageDepartments = () => {
    ...
    const handleDelete = async (id) => {
        if (!window.confirm('Are you sure you want to delete this department? This may fail if it is assigned to courses or faculty.')) {
            return;
        }
                        ...
                        <table className="w-full">
                            <thead className="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Department Name</th>
                                ...
                                {departments.length === 0 ? (
                                    ...
                                    departments.map((dept) => (
                                        <tr key={dept.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            <td className="px-4 py-3 text-sm text-gray-900 dark:text-white">{dept.id}</td>
